...
import kotlinx.android.synthetic.main.activity_kimya_temel_kanunu.*
import kotlinx.android.synthetic.main.activity_rasyonel_sayi.*

class kimyaTemelKanunu : AppCompatActivity() {
    private var mAdView: AdView? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_kimya_temel_kanunu)


        destekTemel5.setOnClickListener {
